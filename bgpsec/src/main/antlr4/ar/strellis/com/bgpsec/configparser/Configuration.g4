...
prog: statement+ ;
statement: (statement_interface|statement_router|statement_options);
...
statement_options: options_desc OPENBRACE option_general+ CLOSEBRACE ;
options_desc: 'options';
option_general: (zebra_socket_desc);
zebra_socket_desc: 'zebra_socket' FILEPATH;
ROUTER: 'router';
NEIGHBOR: 'neighbor';
AUTO: 'auto';
